...
class FilesApi
{
     ...
     * @return \Softonic\StorageApiSdk\Model\File
     ...
     *
     * @param string $id_files SHA-1 hash of the file (required)
     * @return Array of \Softonic\StorageApiSdk\Model\File, HTTP status code, HTTP response headers (array of strings)
     * @throws \Softonic\StorageApiSdk\ApiException on non-2xx response
     */
    public function readFileWithHttpInfo($id_files)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\StorageApiSdk\Model\File',
                '/files/{id_files}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Softonic\StorageApiSdk\Model\File', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\StorageApiSdk\Model\File', $e->getResponseHeaders());
